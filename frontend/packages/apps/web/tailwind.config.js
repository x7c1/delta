  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'surface-sunken-hover': 'var(--delta-color-surface-sunken-hover)',
        ...
        'accent-hover': 'var(--delta-color-accent-hover)',
        'accent-disabled': 'var(--delta-color-accent-disabled)',
        danger: 'var(--delta-color-danger)',
        warning: 'var(--delta-color-warning)',
        info: 'var(--delta-color-info)',
        success: 'var(--delta-color-success)',
