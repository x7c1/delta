...
import type { PendingSendStatus } from "./PendingSendStatus";
 ...
 */
export type PendingSend = { id: number, session_id: string, thread_id: number, 
/**
 ...
 */
locator_quote: string | null, status: PendingSendStatus, 
/**
