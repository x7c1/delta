...
pub(crate) use transcript_lines::{
    ...
    bash_tool_use_line, compact_summary_line, foreground_agent_tool_use_line, interrupt_line,
    local_command_caveat_line, local_command_name_line, local_command_stdout_line,
    queued_command_line, task_notification_line, task_notification_line_both_missing,
