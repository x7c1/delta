...
pub(crate) use transcript_lines::{
    agent_tool_use_line, api_error_line, assistant_line, assistant_line_at, background_tool_use_line,
    bash_tool_use_line, foreground_agent_tool_use_line, interrupt_line, local_command_caveat_line,
    local_command_name_line, local_command_stdout_line, queued_command_line, task_notification_line,
