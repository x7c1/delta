...
mod rejected_registration_leaves_the_spawn_pending;
mod session_end_for_bound_session_is_a_normal_end;
mod session_end_for_failed_resume_sweeps_a_lingering_background_subagent;
...
mod session_start_binds_a_transcript_in_a_missing_directory;
